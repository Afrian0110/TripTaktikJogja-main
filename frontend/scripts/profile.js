class ProfilePage {
    ...
    loadProfileData() {
        const storedData = JSON.parse(localStorage.getItem(`tripTaktikUserProfile_${this.currentUser.name || this.currentUser.email}`));
    ...
    saveProfile() {
        ...
        localStorage.setItem(
            `tripTaktikUserProfile_${this.currentUser.name || this.currentUser.email}`,
    ...
    logout() {
        ...
        if (confirmed) {
            ...
            // localStorage.removeItem(`tripTaktikUserProfile_${this.currentUser.name || this.currentUser.email}`);
